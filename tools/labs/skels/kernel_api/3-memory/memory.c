...
static void memory_exit(void)
{
	...
	printk("ti1:     pid: %d,  timestamp: %lu", ti1->pid, ti1->timestamp);

	printk("ti2:     pid: %d,  timestamp: %lu", ti2->pid, ti2->timestamp);

	printk("ti3:     pid: %d,  timestamp: %lu", ti3->pid, ti3->timestamp);

	printk("ti4:     pid: %d,  timestamp: %lu", ti4->pid, ti4->timestamp);
